...
const generic: HintTurn[] = [
  ...
  { from: "tutor", text: "That's okay. Try naming the pieces first — what is a, what is b, what is c?" },
...
const scripted: Record<string, HintTurn[]> = {
  "quad-3": [
    ...
    { from: "tutor", text: "Try listing pairs that multiply to 12: 1·12, 2·6, 3·4… which pair adds to −7?" },
  ],
  "quad-5": [
    ...
    { from: "tutor", text: "If the number under the square root is positive, you'll get two real answers." },
  ],
};
